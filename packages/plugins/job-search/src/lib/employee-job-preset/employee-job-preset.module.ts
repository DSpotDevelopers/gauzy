...
import { TypeOrmJobSearchCategoryRepository } from './job-search-category/repository';
...
import { TypeOrmJobSearchOccupationRepository } from './job-search-occupation/repository';
...
@Module({
	...
	exports: [TypeOrmModule, JobPresetService, JobSearchCategoryService, JobSearchOccupationService]
})
